#  This is an accompaniment to the lecture on correlation and difference in Week 4
...
stskew <- semTools::skew(survey$tpstress)
stkur<-semTools::kurtosis(survey$tpstress)
