...
#  This is an accompaniment to the lecture.
...
sdata <- read.table("../../Week 3/data/survey.dat")
...
### There are repeated measures ANOVA available which follow the same pattern of input 
...
#We need to load the file so that we can use it in R.
ydata <- read.table("../data/youthcohort.dat")
#Setting the column names to be that used in the dataset
