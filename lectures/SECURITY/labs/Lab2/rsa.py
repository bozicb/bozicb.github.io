...
if __name__ == '__main__':
    ...
    public, private = make_key_pair(10)
    ciphertext1 = public.encrypt(42)
    print "Encrypt 42 with public key:  " + str(ciphertext1)
    plaintext1 = private.decrypt(ciphertext1)
    print "Decrypt 42 with private key: " + str(plaintext1)
