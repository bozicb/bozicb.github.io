...
\question
	\begin{enumerate}
		...
		\begin{answer}
			...
			So:
			\begin{itemize}
				\item $P(h_1|ontime_1,ontime_2)=\alpha (\prod_{j=1}^2 P(ontime_j|h_1))P(h_1)=\alpha 0.75^2 \times 0.25=\alpha 0.140625=\frac{0.140625}{0.28125} \approx 0.5$
				\item $P(h_2|ontime_1,ontime_2)=\alpha (\prod_{j=1}^2 P(ontime_j|h_2))P(h_1)=\alpha 0.50^2 \times 0.50=\alpha 0.125=\frac{0.125}{0.28125} \approx 0.4444$
				\item $P(h_3|ontime_1,ontime_2)=\alpha (\prod_{j=1}^2 P(ontime_j|h_3))P(h_1)=\alpha 0.25^2 \times 0.25=\alpha 0.015625=\frac{0.015625}{0.28125} \approx 0.0556$
			\end{itemize}
		\end{answer}
	...
	P(ontime_{3}|\textbf{d})&=&\sum_i P(ontime_{3}|h_i)P(h_i|\textbf{d})\\
		&=& (0.75 * 0.5) + (0.5 * 0.4444) + (0.25 *0.0556)\\
		&=& 0.375 + 0.2222 + 0.0139\\
		&\approx& 0.6111			
		\end{eqnarray*}
		\end{answer}
