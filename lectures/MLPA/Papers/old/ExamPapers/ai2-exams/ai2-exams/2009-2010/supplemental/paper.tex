...
\begin{enumerate}
		...
		\begin{enumerate}
			...
			\marks{5}
			\begin{answer}
			The key aspects are: the failure nodes are parents of the sensor nodes, and the temperature node is a par ent of both the gauge and the gauge failure node. It is exactly this kind of correlation that makes it difÞcult for humans to understand what is happening in complex systems with unreliable sensors.
